...
mkdir edge-ai
cd edge-ai
bash <(curl -fsSL https://raw.githubusercontent.com/compulab-yokneam/edge-ai-linux/devel-next/scripts/runme.sh)
```
# Flashing target
...
https://docs.nvidia.com/jetson/archives/r36.5/DeveloperGuide/
